...
const STEP_INSIGHTS: Record<string, Record<ScoreBand, CounselorInsight>> = {
  ...
  dp_reassure_shy: {
    strong: {
      title: "Naming the feeling first",
      forChild: "You noticed your friend felt shy and stayed right beside them. Going together makes a big new thing feel smaller.",
      forParent: "Your child validated a feeling before problem-solving — the core move of co-regulation. Name it: “You told them it was okay to feel shy.”",
      skillFocus: "empathy",
      practiceTip: "Practice a “you can feel shy AND come with me” script before a new activity.",
      strengthNoted: "Feeling-validation + patience",
    },
    partial: {
      title: "Encouragement, gently",
      forChild: "Cheering a friend on is kind. Slowing down to name the shy feeling can help even more.",
      forParent: "Warm urgency (“you’ll be fine”) skips the feeling. Coach: acknowledge the feeling, then invite.",
      skillFocus: "calm",
      practiceTip: "Try: “What would help you feel ready?” before “come on.”",
      strengthNoted: "Kind encouragement",
    },
    poor: {
      title: "Rushing grows the worry",
      forChild: "Hurrying a shy friend can make the nervous feeling bigger. A calm, patient hello helps more.",
      forParent: "Avoid pressure language. Model slowing down and offering to go together.",
      skillFocus: "empathy",
      practiceTip: "Role-play waiting calmly while a worried friend gets ready.",
      strengthNoted: "Willingness to retry",
    },
  },
  dp_share_flower: {
    strong: {
      title: "Sharing can make two happy",
      forChild: "You found a way to take turns so you both got the flower. Fair sharing turns a tug-of-war into teamwork.",
      forParent: "Your child generated a mutual solution (turn-taking) rather than win/lose. Reinforce the fairness, not just the giving.",
      skillFocus: "friendship_repair",
      practiceTip: "At home, name turn-taking out loud: “You first, then me.”",
      strengthNoted: "Fair problem-solving",
    },
    partial: {
      title: "Giving is kind",
      forChild: "Letting your friend have it was generous. Next time, you could share it so you both get a turn.",
      forParent: "Self-sacrifice is kind but can become a pattern. Coach mutual solutions where your child’s wants count too.",
      skillFocus: "empathy",
      practiceTip: "Ask: “How could BOTH of you enjoy it?”",
      strengthNoted: "Generosity",
    },
    poor: {
      title: "Grabbing leaves someone out",
      forChild: "Grabbing first meant your friend got nothing. Taking turns lets both of you share the fun.",
      forParent: "Redirect from ownership to fairness without shame: “You really wanted it. Let’s find a turn for each of you.”",
      skillFocus: "friendship_repair",
      practiceTip: "Do-over: “Let’s replay that and try taking turns.”",
      strengthNoted: "Capacity to retry",
    },
  },
  dp_repair_oops: {
    strong: {
      title: "Sorry plus a fix",
      forChild: "You owned the accident and offered to help fix it. A real repair is sorry AND making it right.",
      forParent: "Your child paired an apology with restorative action — the strongest repair skill. Celebrate the courage it took to own it.",
      skillFocus: "friendship_repair",
      practiceTip: "Teach the two-part repair: “I’m sorry for ___. Can I help fix it?”",
      strengthNoted: "Accountability + repair",
    },
    partial: {
      title: "Honesty is a start",
      forChild: "Saying sorry is a good first step. Offering to help fix it makes the friendship feel whole again.",
      forParent: "“It was an accident” explains but doesn’t repair. Add the fix: “What could we do to make it right?”",
      skillFocus: "friendship_repair",
      practiceTip: "Practice adding a helping action after “sorry.”",
      strengthNoted: "Honesty",
    },
    poor: {
      title: "Blame blocks repair",
      forChild: "It was an accident — those happen. Blaming your friend keeps both hearts hurting. A sorry helps.",
      forParent: "Guide away from fault-shifting toward ownership: “Accidents are okay. We still take care of the mess and the feeling.”",
      skillFocus: "friendship_repair",
      practiceTip: "Rewrite the ending with an apology and a fix.",
      strengthNoted: "Openness to guidance",
    },
  },
  dp_quest_start: {
